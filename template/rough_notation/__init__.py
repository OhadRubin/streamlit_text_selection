...
# @st.experimental_memo
# def get_instance(_dataset,index):
#   input_ids = _dataset[index]['input_ids']
#   nei_input_ids = _dataset[index]['nei_input_ids']
...
# instance = get_instance(dataset,index)
# # print(instance)

# num_clicks = rough_notation(instance, key="foo")
